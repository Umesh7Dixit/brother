    ...
    <div id='services' className='w-full bg-white' >
      <motion.div 
        ...
        className='lg:w-[80%] w-[90%] m-auto py-[60px] flex flex-col justify-between items-center gap-[20px]'>
          ...
          <motion.h1 variants={slideUpVariants} className='text-blue-500 text-2xl'>SPECIAL OFFER</motion.h1>
                ...
                allservices.map((item,index) => (
                  <div key={index}>
                    <motion.div
                      ...
                      key={index}>
                           <img src={item.icon} alt="icon" className='w-[70px] border-2 border-blue-500 hover:bg-blue-400 rounded-lg p-2' /> 
